...
(custom-set-variables
 ...
 '(package-selected-packages
   '(paredit lsp-mode ess-view-data hl-todo company ess pdf-tools undo-tree dashboard which-key counsel use-package nano-modeline magit gruvbox-theme doom-modeline)))
(custom-set-faces
